...
namespace WebClient.ICS.Client.Controls
{
    ...
    public partial class MessageWindow
    {
        ...
        public static readonly DependencyProperty CancelTextProperty = DependencyProperty.Register(
            CancelTextPropertyName, typeof(string), typeof(MessageWindow),
        ...
        public static readonly DependencyProperty OkTextProperty = DependencyProperty.Register(
            AcceptTextPropertyName, typeof(string), typeof(MessageWindow),
        ...
        public static readonly DependencyProperty MessageProperty = DependencyProperty.Register(
            MessagePropertyName, typeof (string), typeof (MessageWindow),
        ...
        {
            base.OnClosed(e);
            InvokeClosed(new DialogArgs {Result = DialogResult});
        }
