...
{
	/// <summary>
	/// Class that wraps an object, so that other classes can notify for Change events. 
	/// Typically, this class is set as a Dependency Property on DependencyObjects, 
	/// and allows other classes to observe any changes in the Value.
	/// </summary>
	/// <remarks>
	/// This class is required, because in Silverlight, it's not possible to receive 
	/// Change notifications for Dependency properties that you do not own.
	/// </remarks>
	...
	public class ObservableObject<T> : FrameworkElement, INotifyPropertyChanged
	{
		...
		public static readonly DependencyProperty ValueProperty =
			DependencyProperty.Register("Value", typeof (T), typeof (ObservableObject<T>),
